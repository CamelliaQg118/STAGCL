...
def leiden(adata, n_clusters, use_rep='emb', key_added='STAGCL', random_seed=2023):
...
def louvain(adata, n_clusters, use_rep='emb', key_added='STAGCL', random_seed=2023):
    sc.pp.neighbors(adata, use_rep=use_rep)
...
def mclust_R(adata, n_clusters, use_rep='STAGCL', key_added='STAGCL', random_seed=2024):
    """\
    ...
    # os.environ['R_USER'] = 'C:/Users/GQ/.conda/envs/STAGCL/Lib/site-packages/rpy2'
    modelNames = 'EEE'
